...
const CategoryFashion: React.FC = () => {
  ...
  const getItems = useCallback(async () => {
    try {
      const res = await axios.get(`http://54.180.142.116:8080/api/products/category/list/c3314dca-327b-4187-b0ab-6f67def9fa51`);
      setItems(res.data);
    } catch (error) {
      console.log(error);
    }
  ...
  return (
    <MainDiv>
      <NavBar />
      <Wrap>
        <CategoryName>Fashion Products</CategoryName>
