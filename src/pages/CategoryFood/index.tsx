...
const CategoryFood: React.FC = () => {
  ...
  const getItems = useCallback(async () => {
    try {
      const res = await axios.get(`http://54.180.142.116:8080/api/products/category/list/5e342c92-75fa-41fd-af0f-867e5c83b831`);
      setItems(res.data);
    } catch (error) {
      console.log(error);
    }
  ...
  return (
    <MainDiv>
      <NavBar />
      <Wrap>
        <CategoryName>Food Products</CategoryName>
