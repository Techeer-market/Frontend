...
const CategoryBook_Magazine: React.FC = () => {
  ...
  const getItems = useCallback(async () => {
    try {
      const res = await axios.get(`http://54.180.142.116:8080/api/products/category/list/d0daf4dc-89c8-41bf-8ec1-339d6e037b26`);
      setItems(res.data);
    } catch (error) {
      console.log(error);
    }
  ...
  return (
    <MainDiv>
      <NavBar />
      <Wrap>
        <CategoryName>Book/Magazine Products</CategoryName>
...
export default CategoryBook_Magazine;
